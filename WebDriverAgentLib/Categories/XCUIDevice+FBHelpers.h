...
- (nullable NSData *)fb_screenshotWithError:(NSError*__autoreleasing*)error withOrientation:(UIInterfaceOrientation) orientation andScreenWidth:(CGFloat) screenWidth andScreenHeight:(CGFloat) screenHeight;
/**
